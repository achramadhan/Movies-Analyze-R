...
analisis ini digunakan sebagai personal project untuk mengetahui trend - trend yang ada di dataset movies, data set ini di peroleh dari (https://www.kaggle.com/code/zeeenb/movies/data)
...
```
setelah data duplikat di hapus terdapat 375037 baris
...
wordcloud2(fil_doc, size=.6, color = 'random-light', backgroundColor = "black")
